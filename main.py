...
player = Player(1) #создаёт игрока, хранит информацию о его ресурсах и координатах столицы (см. player.py)
...
while not raylib.WindowShouldClose():
    ...
    units_list.draw_all(camera, world, loaded_map) #рисует всех юнитов
